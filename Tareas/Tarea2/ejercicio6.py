...
def unpad(data):
    ...
    # Si no hubo padding, regresamos la data tal cual
    return data
...
def des_decrypt(data, key):
    keys = generate_keys(key)
    # Invertir claves para el descifrado
    keys.reverse()
    result = b""
    ...
    # Quitar el relleno al mensaje descifrado
    return unpad(result)
...
if __name__ == "__main__":
    ...
    # Convertir a Base64
    cipher_base64 = base64.b64encode(cipher).decode("ascii")
    print(f"Texto cifrado (Base64):\n{cipher_base64}")

    print("\n--- PROCESO DE DESCIFRADO ---")
    
    # Decodificar Base64
    cipher_bytes_decoded = base64.b64decode(cipher_base64)
    
    # Descifrar
    decrypted = des_decrypt(cipher_bytes_decoded, key)
